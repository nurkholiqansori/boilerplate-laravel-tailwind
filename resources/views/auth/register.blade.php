...
<div class="md:p-12 md:mx-6  md:justify-center min-h-full md:flex md:flex-col p-10">
  <div class="text-center">
    ...
    <h4 class="text-xl font-semibold mt-1 mb-5 pb-1">Register</h4>
  </div>
  @include('_partials.messages')
  <form method="POST" action="{{ route('register.perform') }}">
    @csrf
    <p class="mb-4">Mohon untuk mendaftar agar bisa mengakses fitur</p>
    <div class="mb-4">
      <input type="text" class="form-input" id="name" placeholder="Nama" name="name" />
    </div>
    <div class="mb-4">
      <input type="email" class="form-input" id="email" placeholder="Email" name="email" />
    </div>
    <div class="mb-4">
      <input type="text" class="form-input" id="username" placeholder="Username" name="username" />
    </div>
    <div class="mb-4 flex">
    ...
    <div class="mb-4">
      <input type="password" class="form-input" id="password_confirmation" placeholder="Konfirmasi Password"
    ...
    <div class="flex items-center justify-between pb-6 flex-col md:flex-row gap-5">
      ...
      <a href="{{ route('login.index') }}" type="button" class="button-secondary">
        Masuk
      </a>
    </div>
  </form>
