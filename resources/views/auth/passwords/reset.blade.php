...
<div class="md:p-12 md:mx-6  md:justify-center min-h-full md:flex md:flex-col p-10">
  <div class="text-center">
    ...
    <h4 class="text-xl font-semibold mt-1 mb-5 pb-1">Ganti Password</h4>
  </div>
  @include('_partials.messages')
  <form method="post" action="{{ route('password.resetpassword.perform') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-4">
      <input type="password" class="form-input" id="formPassword" placeholder="Konfirmasi Password"
